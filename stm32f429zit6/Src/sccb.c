...
#define FULL_DELAY 44
#define HALF_DELAY FULL_DELAY/2
#define SDIO_C 11 /* PC11 */
#define SDIO_D 12 /* PC12 */

#define SET_HIGH(PIN) (GPIOC->BSRRL = 1 << PIN)
#define SET_LOW(PIN) (GPIOC->BSRRH = 1 << PIN)
#define DATA_IN() (GPIOC->MODER = GPIOC->MODER & 0xfeffffff);
#define DATA_OUT() (GPIOC->MODER = GPIOC->MODER | 0x01000000)
#define DATA_HIGH() (GPIOC->IDR & 0x00001000)
